...
p {
   ...
   <div class="ta">
	   ...
	   <h2 class =" heading">Edit Employee Information</h2>
			<form action="updateemp.php" method="POST">
	<div class="a">
	<p>Employee ID<br>
	<input type="number" name="employee_id" value="<?php print $_GET['Employee_ID'];?>" style="text-align:center;opacity:0.8;"readonly/>
	<p>Employee Name<br>
