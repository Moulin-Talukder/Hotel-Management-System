...
<table style="width:80%">
  <tr style="color:blue">
    <center>
    <h1 style="margin: 16% 0%">Guest Information</h1></center>
    <th>Guest_ID</th>
    <th>Guest_Name</th> 
    <th>Phone</th>
    <th>Address</th>
...
<?php
  ...
  $SQL = "SELECT * FROM `tb_guest` WHERE '".$searchKeyword."' IN (Guest_ID,Guest_Name,Phone,Address,NID_No);";
