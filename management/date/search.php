...
<table style="width:80%">
  <tr style="color:blue">
    <center>
    <h1 style="margin: 16% 0%">Date Information</h1></center>
    <th>Date_ID</th>
    <th>Starting_Date</th> 
    <th>Ending_Date</th>
  </tr>
...
<?php
  ...
  $SQL = "SELECT * FROM `tb_date` WHERE '".$searchKeyword."' IN (Date_ID,Starting_Date,Ending_Date);";
...
?>
      ...
      <div class="uu">
	   ...
	   <p>Created By:Talukder Makid Uddin Moulin  <br>ID:17103345
	   </p>
	   </div>
       </div>
