...
p {
   ...
   <div class="ta">
	   ...
	   <h2 class =" heading">Edit Room Information</h2>
			<form action="updateroom.php" method="POST">
	<div class="a">
	<p>Room ID<br>
	<input type="number" name="room_id" value="<?php print $_GET['Room_ID'];?>" style="text-align:center;opacity:0.8;"readonly/>
	<p>Room No<br>
		<input type="text" name="room_no" value=""></p>
	<p>Type<br>
		<input type="text" name="type" value=""></p>
	<p>Rent<br>
		<input type="text" name="rent" value=""></p>
