...
.heading {
   ...
   <div class="ta">
	   ...
	   <h2 class =" heading">Update Guest Information</h2>
	<div class="toast">
		<?php
...
$sql="UPDATE tb_guest SET Guest_Name = '".$_POST['guest_name']."', Phone ='".$_POST['phone']."', Address ='".$_POST['address']."', NID_No ='".$_POST['nid_no']."' WHERE Guest_ID = '".$_POST['guest_id']."'";
